const EnemySprites = {
  hit : {
    ...
    ,{x:5,y:3},{x:6,y:3},{x:7,y:3},{x:8,y:3},{x:9,y:3}],
    up_fight : [{x:0,y:1},{x:1,y:1},{x:2,y:1},{x:3,y:1},{x:4,y:1}],
    down_fight : [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:3,y:0},{x:4,y:0}],
    left_fight : [{x:0,y:1},{x:1,y:1},{x:2,y:1},{x:3,y:1},{x:4,y:1}],
    right_fight : [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:3,y:0},{x:4,y:0}],
    idle : [{x:8,y:1}],
    dying_SpriteTable : [{x:0,y:2},{x:1,y:2},{x:2,y:2},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:6,y:2},{x:6,y:2},{x:6,y:2},{x:6,y:2},{x:6,y:2},{x:6,y:2}],
    dead_SpriteTable : [{x:7,y:2},{x:8,y:2},{x:9,y:2}],
  }, hulk : {
